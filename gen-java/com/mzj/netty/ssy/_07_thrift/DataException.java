 ...
 *  @generated
 */
package com.mzj.netty.ssy._07_thrift;

@SuppressWarnings({"cast", "rawtypes", "serial", "unchecked", "unused"})
@javax.annotation.Generated(value = "Autogenerated by Thrift Compiler (0.12.0)", date = "2020-02-15")
public class DataException extends org.apache.thrift.TException implements org.apache.thrift.TBase<DataException, DataException._Fields>, java.io.Serializable, Cloneable, Comparable<DataException> {
  ...
  private static final org.apache.thrift.protocol.TField CALLS_STACK_FIELD_DESC = new org.apache.thrift.protocol.TField("callsStack", org.apache.thrift.protocol.TType.STRING, (short)2);
  ...
  public @org.apache.thrift.annotation.Nullable java.lang.String callsStack; // optional
  public @org.apache.thrift.annotation.Nullable java.lang.String date; // optional

  /** The set of fields this struct contains, along with convenience methods for finding and manipulating them. */
  public enum _Fields implements org.apache.thrift.TFieldIdEnum {
    MESSAGE((short)1, "message"),
    CALLS_STACK((short)2, "callsStack"),
    DATE((short)3, "date");
  ...
  private static final _Fields optionals[] = {_Fields.MESSAGE,_Fields.CALLS_STACK,_Fields.DATE};
  public static final java.util.Map<_Fields, org.apache.thrift.meta_data.FieldMetaData> metaDataMap;
  static {
    java.util.Map<_Fields, org.apache.thrift.meta_data.FieldMetaData> tmpMap = new java.util.EnumMap<_Fields, org.apache.thrift.meta_data.FieldMetaData>(_Fields.class);
    tmpMap.put(_Fields.MESSAGE, new org.apache.thrift.meta_data.FieldMetaData("message", org.apache.thrift.TFieldRequirementType.OPTIONAL, 
        new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.STRING        , "String")));
    tmpMap.put(_Fields.CALLS_STACK, new org.apache.thrift.meta_data.FieldMetaData("callsStack", org.apache.thrift.TFieldRequirementType.OPTIONAL, 
        new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.STRING        , "String")));
  ...
  public DataException(DataException other) {
    ...
    if (other.isSetCallsStack()) {
      this.callsStack = other.callsStack;
    }
    if (other.isSetDate()) {
  ...
  @org.apache.thrift.annotation.Nullable
  public java.lang.String getCallsStack() {
    return this.callsStack;
  }

  public DataException setCallsStack(@org.apache.thrift.annotation.Nullable java.lang.String callsStack) {
    this.callsStack = callsStack;
    return this;
  }

  public void unsetCallsStack() {
    this.callsStack = null;
  }

  /** Returns true if field callsStack is set (has been assigned a value) and false otherwise */
  public boolean isSetCallsStack() {
    return this.callsStack != null;
  }

  public void setCallsStackIsSet(boolean value) {
    if (!value) {
      this.callsStack = null;
    }
  }
  ...
  public void setFieldValue(_Fields field, @org.apache.thrift.annotation.Nullable java.lang.Object value) {
    ...
    case CALLS_STACK:
      if (value == null) {
        ...
        setCallsStack((java.lang.String)value);
      }
      break;
  ...
  public boolean equals(DataException that) {
    ...
    boolean this_present_callsStack = true && this.isSetCallsStack();
    boolean that_present_callsStack = true && that.isSetCallsStack();
    if (this_present_callsStack || that_present_callsStack) {
      if (!(this_present_callsStack && that_present_callsStack))
        return false;
      if (!this.callsStack.equals(that.callsStack))
        return false;
    }
  ...
  public int hashCode() {
    ...
    hashCode = hashCode * 8191 + ((isSetCallsStack()) ? 131071 : 524287);
    if (isSetCallsStack())
      hashCode = hashCode * 8191 + callsStack.hashCode();
  ...
  public int compareTo(DataException other) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetCallsStack()).compareTo(other.isSetCallsStack());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetCallsStack()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.callsStack, other.callsStack);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
  ...
  public java.lang.String toString() {
    ...
    if (isSetCallsStack()) {
      if (!first) sb.append(", ");
      sb.append("callsStack:");
      if (this.callsStack == null) {
        sb.append("null");
      } else {
        sb.append(this.callsStack);
      }
      first = false;
    }
    if (isSetDate()) {
  ...
  private static class DataExceptionStandardScheme extends org.apache.thrift.scheme.StandardScheme<DataException> {
    ...
    public void read(org.apache.thrift.protocol.TProtocol iprot, DataException struct) throws org.apache.thrift.TException {
      ...
      while (true)
      {
        ...
        switch (schemeField.id) {
          ...
          case 2: // CALLS_STACK
            if (schemeField.type == org.apache.thrift.protocol.TType.STRING) {
              struct.callsStack = iprot.readString();
              struct.setCallsStackIsSet(true);
            } else { 
              org.apache.thrift.protocol.TProtocolUtil.skip(iprot, schemeField.type);
            }
            break;
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, DataException struct) throws org.apache.thrift.TException {
      ...
      if (struct.callsStack != null) {
        if (struct.isSetCallsStack()) {
          oprot.writeFieldBegin(CALLS_STACK_FIELD_DESC);
          oprot.writeString(struct.callsStack);
          oprot.writeFieldEnd();
        }
      }
      if (struct.date != null) {
