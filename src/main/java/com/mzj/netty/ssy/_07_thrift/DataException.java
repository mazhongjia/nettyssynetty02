...
public class DataException extends org.apache.thrift.TException implements org.apache.thrift.TBase<DataException, DataException._Fields>, java.io.Serializable, Cloneable, Comparable<DataException> {
  ...
  public @org.apache.thrift.annotation.Nullable String callsStack; // optional
  ...
  @org.apache.thrift.annotation.Nullable
  public String getCallsStack() {
    return this.callsStack;
  }

  public DataException setCallsStack(@org.apache.thrift.annotation.Nullable String callsStack) {
  ...
  public int compareTo(DataException other) {
    ...
    lastComparison = Boolean.valueOf(isSetCallsStack()).compareTo(other.isSetCallsStack());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetCallsStack()) {
